<?php
class MemberspageHandler {

    private $settings; // Declare the property

    public function __construct() {
        $this->settings = Members_Settings::get_instance(); // Initialize it in the constructor
    }
    ...
    public function createPages() {
		...
		//$swpm_join_page_permalink = get_permalink($join_page_id);
			$swpm_join_page_permalink = '';
		$this->settings->set_value( 'join-us-page-url', $swpm_join_page_permalink );
		...
		$swpm_rego_page_permalink = '';
		$this->settings->set_value( 'registration-page-url', $swpm_rego_page_permalink );
		...
		$swpm_login_page_permalink ='';
		$this->settings->set_value( 'login-page-url', $swpm_login_page_permalink );
		...
		$swpm_reset_page_permalink = '';
		$this->settings->set_value( 'reset-page-url', $swpm_reset_page_permalink );
		...
		$swpm_thank_you_page_permalink = '';
		$this->settings->set_value( 'thank-you-page-url', $swpm_thank_you_page_permalink );
...
$handler = new MemberspageHandler();
$handler->createPages();
